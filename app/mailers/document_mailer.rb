class DocumentMailer < ApplicationMailer
    ...
    def send_document(document)
      @document = document
      attachments["documento_#{document.id}.pdf"] = File.binread(Rails.root.join('public', 'pdfs', "documento_#{document.id}.pdf"))
    ...
    def send_document_hist(document)
      @document = document
      attachments["historico_#{document.id}.pdf"] = File.binread(Rails.root.join('public', 'pdfs', "historico_#{document.id}.pdf"))
